...
export default function Registration() {
  ...
  return (
    <div className="cgradient container-fluid default">
      <div className="col-10 col-md-6 col-lg-4 position-absolute border-primary top-50 start-50 translate-middle container cbg-dark px-5 py-4 rounded-2 shadow-lg">
        {/* heading */}
        <h1 className="col-4 col-md-6 fw-bold offset-4 offset-md-3 text-center fs-4 p-3 text-uppercase ctext-secondary">
          Sign Up
        </h1>
        ...
        >
          ...
          {/* actions */}
          <div className="ctext-secondary fw-bold row col-12 d-flex flex-column justify-content-center align-items-center">
